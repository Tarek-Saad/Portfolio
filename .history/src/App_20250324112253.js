...
function App() {
    ...
    const projects = [{
            ...
            description: "Care Pulse Health Care is a platform dedicated to providing comprehensive health services and wellness information. It offers users easy access to healthcare professionals, services, and resources tailored to their needs.",
        ...
        },
        {
            ...
            description: "Tech Trove Shop is an online store specializing in electronic products and gadgets. It features a modern interface that allows users to browse a wide range of items, including laptops, smartphones, and accessories. The site typically includes product categories, detailed descriptions, and user-friendly navigation for seamless shopping experiences.",
        ...
        },
        {
            ...
            description: "Chat-2-Chat is an interactive platform designed for real-time messaging, allowing users to connect with others seamlessly. The website features a clean interface that facilitates easy conversations and includes options for group chats and private messaging. Users can create accounts, manage their contacts, and engage in meaningful discussions. The goal of Chat-2-Chat is to enhance communication and foster connections among users in a friendly environment.",
        ...
        },
        {
            ...
            description: "The Healthcare Management System is a comprehensive application designed to manage hospital operations, including patient records, appointments, staff, and billing.",
        ...
        },
        {
            ...
            description: "The Brain Wave AI website showcases innovative artificial intelligence solutions aimed at enhancing productivity and creativity. It features various AI-driven tools designed to assist users in different tasks, providing an intuitive interface for easy access. The platform emphasizes the potential of AI to transform workflows and boost efficiency.",
        ...
        },
        {
            ...
            description: "Travel App is a dynamic platform designed to help adventurers explore nature and new destinations with ease. The app features offline maps, making it a reliable tool for hikers and travelers in remote areas without an internet connection. Users can search for trails, landmarks, and nature spots, and plan their journeys using the app's intuitive interface. With a focus on user experience, the app provides essential travel information and guidance for every adventure.",
        ...
        },
        {
            ...
            description: "Red Store Online Shop is a vibrant e-commerce platform that specializes in showcasing workout apparel and the latest fitness offerings. The website provides users with a comprehensive shopping experience, featuring a wide range of products, detailed descriptions, and high-quality images. Customers can easily browse through categories, filter by size and style, and make purchases with confidence. With a focus on user experience, the site is designed to be fast, responsive, and easy to navigate, ensuring that users can find exactly what they need for their fitness journey.",
        ...
        },
        {
            ...
            description: "TBH-Zen Resort is a luxurious boutique hotel located in the beautiful coastal city of Hurghada. The website showcases the resort's exquisite accommodations, stunning views, and exceptional service. Visitors can explore the resort's amenities, book their stay, and learn about local attractions and activities. Designed with user experience in mind, the site features a visually appealing layout, easy navigation, and responsive design, ensuring that potential guests can easily find the information they need to plan their perfect getaway.",
        ...
        },
        {
            ...
            description: "Shopping Bag is an online retail platform designed for easy browsing and purchasing of a variety of products. The site offers a clean layout with user-friendly navigation, allowing customers to explore categories, view detailed product descriptions, and add items to their shopping cart seamlessly. With a focus on providing a smooth shopping experience, Shopping Bag aims to cater to diverse consumer needs.",
            ghLink: "https://github.com/FadyAdel04/Tech-Trove-Shop",
        ...
        },
        {
            ...
            description: "The AdminHub project is a responsive admin dashboard template that utilizes modern design principles. It features a user-friendly interface with various components, including charts, tables, and forms, suitable for managing data and monitoring application performance. The design emphasizes usability",
